from the_zero_page import main_apge_tiems

# 调用 main_apge_tiems 函数.
main_page_info = main_page_items(
    './htmlfiles/main_pages/2018-01-30 15/36/07.html')
...
try:
    if jump_to_page_havent_been_crawled:
        ...
        page_number = math.floor(
            have_been_crawed_items_number / home_page_items_number)
except:
    pass
    # page_number += 1
